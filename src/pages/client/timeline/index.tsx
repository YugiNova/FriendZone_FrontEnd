...
import { About, Container, Event, InfoItem, Introduce, LeftWrapper, PhotoList, Photos, PostWrapper, Title } from "./styles"
        ...
        <Container theme={theme}>
            <LeftWrapper>
                <Introduce theme={theme}>
                    ...
                    <About theme={theme}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at commodo non, feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac massa sed rhoncus</About>
                    <InfoItem theme={theme}><AiFillHome/>Ho Chi Minh City</InfoItem>
                    <InfoItem theme={theme}><MdSchool/>Ton Duc Thang Univerity</InfoItem>
                    <InfoItem theme={theme}><FaBirthdayCake/>30/02/1999</InfoItem>
                </Introduce>
                <Photos theme={theme}>
